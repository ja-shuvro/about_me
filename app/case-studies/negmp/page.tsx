    ...
    <div className="bg-background text-text min-h-screen selection:bg-accent/30 selection:text-white">
            ...
            >
               ...
               <div className="space-y-8">
                  <div>
                    ...
                    <div className="text-sm text-muted">A coherent, deployable system from database schema to satellite pipeline.</div>
                  </div>
                  <div>
      ...
      <section className="py-24 relative overflow-hidden bg-surface/10">
        <div className="container mx-auto px-6">
          ...
          <div className="mt-12 text-center text-muted italic">
             &quot;Expansion for future programs costs a fraction of a new build.&quot;
          </div>
        </div>
      </section>
